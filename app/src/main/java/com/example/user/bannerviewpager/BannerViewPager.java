...
public class BannerViewPager extends ViewPager {
    ...
    private int scrollTime = 5 * 1000; //滚动时间间隔
...
//                ImageLoader.getInstance().displayImage(mUrllist.get(i).getImageUrl(), imageview, ImageLoaderUtils.getOptions());
    ...
    public void start(Context context, List<BannerBean> list, List<BannerBean> adsId, LinearLayout ovalLayout, int focusedId, int normalId){
        stopTimer();
